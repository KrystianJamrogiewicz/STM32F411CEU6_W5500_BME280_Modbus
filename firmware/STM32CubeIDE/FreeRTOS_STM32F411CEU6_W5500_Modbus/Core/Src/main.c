...
/* Definitions for Mutex_SensorData */
osMutexId_t Mutex_SensorDataHandle;
const osMutexAttr_t Mutex_SensorData_attributes = {
  .name = "Mutex_SensorData"
};
/* Definitions for Sem_W5500_INT */
osSemaphoreId_t Sem_W5500_INTHandle;
const osSemaphoreAttr_t Sem_W5500_INT_attributes = {
  .name = "Sem_W5500_INT"
};
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  osKernelInitialize();
  /* Create the mutex(es) */
  /* creation of Mutex_SensorData */
  Mutex_SensorDataHandle = osMutexNew(&Mutex_SensorData_attributes);
  ...
  /* creation of Sem_W5500_INT */
  Sem_W5500_INTHandle = osSemaphoreNew(1, 0, &Sem_W5500_INT_attributes);
  ...
  Task_SensorHandle = osThreadNew(vSensorTask, NULL, &Task_Sensor_attributes);

  /* creation of Task_Network */
  Task_NetworkHandle = osThreadNew(vNetworkTask, NULL, &Task_Network_attributes);
